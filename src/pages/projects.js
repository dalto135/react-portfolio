...
function Projects() {
    ...
    let descriptions = [
        'A web application that allows users to post and search for items that have been reported missing. Technologies used include Sequelize, Javascript, Handlebars, and MYSQL2.',
        ...
        <section id="work-me">
            ...
            <div className="content" id="work">
                ...
                <div className='big'>
                    ...
                    <Project title={titles[0]} link={links[0]} screenshot={projects[0].screenshot} description={descriptions[0]} githubLink={githubLinks[0]}/>

                    <Project title={titles[1]} link={links[1]} screenshot={projects[1].screenshot} description={descriptions[1]} githubLink={githubLinks[1]}/>
                ...
                <div className="big">
                    ...
                    <Project title={titles[2]} link={links[2]} screenshot={projects[2].screenshot} description={descriptions[2]} githubLink={githubLinks[2]}/>

                    <Project title={titles[3]} link={links[3]} screenshot={projects[3].screenshot} description={descriptions[3]} githubLink={githubLinks[3]}/>
                ...
                <div className="big">
                    ...
                    <Project title={titles[4]} link={links[4]} screenshot={projects[4].screenshot} description={descriptions[4]} githubLink={githubLinks[4]}/>

                    <Project title={titles[5]} link={links[5]} screenshot={projects[5].screenshot} description={descriptions[5]} githubLink={githubLinks[5]}/>
